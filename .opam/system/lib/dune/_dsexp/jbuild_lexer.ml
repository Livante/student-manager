...
and __ocaml_lex_token_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 26 "src/dsexp/jbuild_lexer.mll"
    ( Lexing.new_line lexbuf; token lexbuf )
# 191 "src/dsexp/jbuild_lexer.ml"

  | 1 ->
# 28 "src/dsexp/jbuild_lexer.mll"
    ( token lexbuf )
# 196 "src/dsexp/jbuild_lexer.ml"

  | 2 ->
# 30 "src/dsexp/jbuild_lexer.mll"
    ( Token.Lparen )
# 201 "src/dsexp/jbuild_lexer.ml"

  | 3 ->
# 32 "src/dsexp/jbuild_lexer.mll"
    ( Rparen )
# 206 "src/dsexp/jbuild_lexer.ml"

  | 4 ->
# 34 "src/dsexp/jbuild_lexer.mll"
...
# 216 "src/dsexp/jbuild_lexer.ml"

  | 5 ->
# 41 "src/dsexp/jbuild_lexer.mll"
    ( block_comment lexbuf;
      token lexbuf
    )
# 223 "src/dsexp/jbuild_lexer.ml"

  | 6 ->
# 45 "src/dsexp/jbuild_lexer.mll"
    ( Sexp_comment )
# 228 "src/dsexp/jbuild_lexer.ml"

  | 7 ->
# 47 "src/dsexp/jbuild_lexer.mll"
    ( Eof )
# 233 "src/dsexp/jbuild_lexer.ml"

  | 8 ->
# 49 "src/dsexp/jbuild_lexer.mll"
    ( atom "" (Lexing.lexeme_start_p lexbuf) lexbuf )
# 238 "src/dsexp/jbuild_lexer.ml"
...
and __ocaml_lex_atom_rec acc start lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 53 "src/dsexp/jbuild_lexer.mll"
    ( lexbuf.lex_start_p <- start;
      error lexbuf "jbuild atoms cannot contain #|"
    )
# 252 "src/dsexp/jbuild_lexer.ml"

  | 1 ->
# 57 "src/dsexp/jbuild_lexer.mll"
    ( lexbuf.lex_start_p <- start;
      error lexbuf "jbuild atoms cannot contain |#"
    )
# 259 "src/dsexp/jbuild_lexer.ml"

  | 2 ->
let
# 60 "src/dsexp/jbuild_lexer.mll"
                                               s
# 265 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 61 "src/dsexp/jbuild_lexer.mll"
    ( atom (if acc = "" then s else acc ^ s) start lexbuf
    )
# 270 "src/dsexp/jbuild_lexer.ml"

  | 3 ->
# 64 "src/dsexp/jbuild_lexer.mll"
    ( if acc = "" then
...
and __ocaml_lex_quoted_string_rec mode lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 73 "src/dsexp/jbuild_lexer.mll"
    ( Buffer.contents escaped_buf )
# 292 "src/dsexp/jbuild_lexer.ml"

  | 1 ->
# 75 "src/dsexp/jbuild_lexer.mll"
...
# 300 "src/dsexp/jbuild_lexer.ml"

  | 2 ->
let
# 79 "src/dsexp/jbuild_lexer.mll"
               s
# 306 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 80 "src/dsexp/jbuild_lexer.mll"
    ( Lexing.new_line lexbuf;
      Buffer.add_string escaped_buf s;
      quoted_string mode lexbuf
    )
# 313 "src/dsexp/jbuild_lexer.ml"

  | 3 ->
let
# 84 "src/dsexp/jbuild_lexer.mll"
         c
# 319 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 85 "src/dsexp/jbuild_lexer.mll"
    ( Buffer.add_char escaped_buf c;
      quoted_string mode lexbuf
    )
# 325 "src/dsexp/jbuild_lexer.ml"

  | 4 ->
# 89 "src/dsexp/jbuild_lexer.mll"
    ( if mode = In_block_comment then
        error lexbuf "unterminated quoted string";
      Buffer.contents escaped_buf
    )
# 333 "src/dsexp/jbuild_lexer.ml"
...
and __ocaml_lex_quoted_string_after_escaped_newline_rec mode lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 96 "src/dsexp/jbuild_lexer.mll"
    ( quoted_string mode lexbuf )
# 345 "src/dsexp/jbuild_lexer.ml"
...
and __ocaml_lex_block_comment_rec lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 100 "src/dsexp/jbuild_lexer.mll"
    ( Buffer.clear escaped_buf;
      ignore (quoted_string In_block_comment lexbuf : string);
      block_comment lexbuf
    )
# 360 "src/dsexp/jbuild_lexer.ml"

  | 1 ->
# 105 "src/dsexp/jbuild_lexer.mll"
    ( ()
    )
# 366 "src/dsexp/jbuild_lexer.ml"

  | 2 ->
# 108 "src/dsexp/jbuild_lexer.mll"
    ( error lexbuf "unterminated block comment"
    )
# 372 "src/dsexp/jbuild_lexer.ml"

  | 3 ->
# 111 "src/dsexp/jbuild_lexer.mll"
    ( block_comment lexbuf
    )
# 378 "src/dsexp/jbuild_lexer.ml"
...
and __ocaml_lex_escape_sequence_rec mode lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 116 "src/dsexp/jbuild_lexer.mll"
    ( Lexing.new_line lexbuf;
      Newline )
# 391 "src/dsexp/jbuild_lexer.ml"

  | 1 ->
let
# 118 "src/dsexp/jbuild_lexer.mll"
                                       c
# 397 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 119 "src/dsexp/jbuild_lexer.mll"
    ( let c =
        match c with
        | 'n' -> '\n'
        | 'r' -> '\r'
...
# 411 "src/dsexp/jbuild_lexer.ml"

  | 2 ->
let
# 130 "src/dsexp/jbuild_lexer.mll"
              c1
# 417 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos
and
# 130 "src/dsexp/jbuild_lexer.mll"
                            c2
# 422 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1)
and
# 130 "src/dsexp/jbuild_lexer.mll"
                                          c3
# 427 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2) in
# 131 "src/dsexp/jbuild_lexer.mll"
...
# 437 "src/dsexp/jbuild_lexer.ml"

  | 3 ->
let
# 138 "src/dsexp/jbuild_lexer.mll"
              s
# 443 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 139 "src/dsexp/jbuild_lexer.mll"
...
# 452 "src/dsexp/jbuild_lexer.ml"

  | 4 ->
let
# 145 "src/dsexp/jbuild_lexer.mll"
                     c1
# 458 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1)
and
# 145 "src/dsexp/jbuild_lexer.mll"
                                      c2
# 463 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 2) in
# 146 "src/dsexp/jbuild_lexer.mll"
    ( let v = eval_hex_escape c1 c2 in
      Buffer.add_char escaped_buf (Char.chr v);
      Other
    )
# 470 "src/dsexp/jbuild_lexer.ml"

  | 5 ->
let
# 150 "src/dsexp/jbuild_lexer.mll"
                     s
# 476 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme lexbuf lexbuf.Lexing.lex_start_pos lexbuf.Lexing.lex_curr_pos in
# 151 "src/dsexp/jbuild_lexer.mll"
    ( if mode = In_quoted_string then
...
# 485 "src/dsexp/jbuild_lexer.ml"

  | 6 ->
let
# 157 "src/dsexp/jbuild_lexer.mll"
         c
# 491 "src/dsexp/jbuild_lexer.ml"
= Lexing.sub_lexeme_char lexbuf lexbuf.Lexing.lex_start_pos in
# 158 "src/dsexp/jbuild_lexer.mll"
    ( Buffer.add_char escaped_buf '\\';
      Buffer.add_char escaped_buf c;
      Other
    )
# 498 "src/dsexp/jbuild_lexer.ml"

  | 7 ->
# 163 "src/dsexp/jbuild_lexer.mll"
    ( if mode = In_quoted_string then
        error lexbuf "unterminated escape sequence" ~delta:(-1);
      Other
    )
# 506 "src/dsexp/jbuild_lexer.ml"
